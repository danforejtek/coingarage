...
const FiveSteps = (): ReactElement => {
  ...
  return (
    <>
      ...
      <div
        id="steps-root"
        className="relative mt-12 flex w-full max-w-[1280px] flex-col items-center justify-between gap-2 lg:flex-row lg:gap-5 lg:px-6 xl:px-8"
      >
        ...
        {steps.map((step, index) => (
          <>
            ...
            {index < steps.length - 1 && (
              <ChevronDown className="h-6 w-6 text-primary/80 lg:-rotate-90 xl:flex-shrink-0" />
            )}
          </>
        ))}
      </div>
