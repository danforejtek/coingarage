...
const IconFigure = ({
  ...
  return (
    <figure className="xl:w-[186px] w-[256px] h-[192px] rounded-lg border bg-background px-2 pb-6 pt-2 shadow transition-all dark:border-none dark:bg-[#282930]">
      <div className="flex flex-row-reverse">
        {icon || <Image src={statusImage} width={18} height={18} alt="" />}
      </div>
...
const FiveSteps = (): ReactElement => {
  ...
  return (
    <>
      ...
      <div className="relative w-full mt-12 flex grid-cols-5 grid-rows-1 flex-col flex-wrap gap-5 lg:flex-row lg:pl-8 lg:grid">
