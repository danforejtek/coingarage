      ...
      <div className="">
        <div className="mt-6 flex flex-col gap-4 lg:mt-16 lg:w-1/2">
          ...
          <div className="justify-left mt-20 flex w-full flex-row">
            <Button className="mt-12 min-w-64 md:mt-4 ">{etMain("startBtn")}</Button>
          </div>
        </div>
      </div>

      <div className="mt-28 flex w-full flex-row flex-wrap items-center justify-center gap-6 sm:mt-48 md:mt-32">
