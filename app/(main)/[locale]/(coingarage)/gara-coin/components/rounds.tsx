    ...
    <div className="mx-2">
      <div className="my-2 flex w-full flex-row justify-center gap-2">
        {Number(calculateRound()) === Number(1) ? (
          ...
          <div className="flex flex-1 flex-col items-center gap-1 rounded-xl bg-gary-input-blue px-6 py-2 text-center border border-neutral px-6 py-2 border border-neutral-300/30">
            <p className="text-xs font-bold leading-none text-white">
              1<sup>st</sup> round
            </p>
        ...
        {Number(calculateRound()) === Number(2) ? (
          ...
          <div className="flex flex-1 flex-col items-center gap-1 rounded-xl border border-neutral px-6 py-2 text-center border border-neutral-300/30">
            <p className="text-xs font-bold leading-none text-white">
              2<sup>nd</sup> round
            </p>
