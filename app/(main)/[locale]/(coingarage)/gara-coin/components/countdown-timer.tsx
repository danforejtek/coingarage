...
import "../components/buy-gara-widget/widget.css"
...
const CountdownTimer = ({ className }: { className?: string }) => {
  ...
  return (
    <div className={cn("flex w-full items-center justify-center space-x-2", className)}>
      <div className="gara-countdown flex w-full flex-col items-center rounded-xl bg-gary-blue p-2 font-heading shadow-md">
